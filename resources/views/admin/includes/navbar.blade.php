    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="{{route('dashboard')}}">
            ...
            <b class="logo-icon">
                ...
                <!-- Dark Logo icon -->
                <img src="/storage/photos/admin/kucuk_logo.png"  class="dark-logo" style="height: 50px; width:50px;"  />
                <!-- Light Logo icon -->
                <img src="/storage/photos/admin/kucuk_logo.png" class="light-logo" style="height: 50px; width:50px;"/>
            </b>
            <!--End Logo icon -->
            <!-- Logo text -->
            <span class="logo-text">
                <!-- dark Logo text -->
                <img src="/storage/photos/admin/logo_text_dark.png" class="dark-logo" style="height: 30px;"/>
                <!-- Light Logo text -->
                <img src="/storage/photos/admin/logo_text.png" class="light-logo" style="height: 150px; width:150px;"/>
              </span>
        </a>
        <!-- -------------------------------------------------------------- -->
        <!-- End Logo -->
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end user-dd animated flipInY">
                    ...
                    <a class="dropdown-item" target="_blank" href="{{route('home')}}">
                        <i data-feather="aperture" class="feather-sm text-success me-1 ms-1"></i> Siteyi Görüntüle</a>
                    <div class="dropdown-divider"></div>
                    <form action="{{route('logout')}}" method="POST">
                        <button class="dropdown-item"><i data-feather="log-out" class="feather-sm text-danger me-1 ms-1"></i>Güvenli Çıkış</button>
                    </form>
                    <div class="dropdown-divider"></div>
                    <div class="pl-4 p-2">
                        <a href="{{route('profile.show')}}" class="btn d-block w-100 btn-primary rounded-pill">Hesap Ayarları</a>
                    </div>
                </div>
            </li>
            <!-- -------------------------------------------------------------- -->
